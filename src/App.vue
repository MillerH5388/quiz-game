  ...
  <div>
    ...
    <template v-if="this.question">
      ...
      <section v-if="this.answerSubmitted" class="result">
          <h4 v-if="this.chosenAnswer == this.correctAnswer">😉 Resposta Correta, Parabéns</h4>
          <h4 v-else v-html="'❌ Respota incorreta, a respota correta é ' + this.correctAnswer "></h4>
          <button @click="this.getNewQuestion()" type="button" class="send">Próxima pergunta</button>
      </section>
